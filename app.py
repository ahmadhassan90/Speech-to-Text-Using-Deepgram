...
def main():
    ...
    # Step 1: Input Deepgram API Key
    st.subheader("Step 1: Enter Your Deepgram API Key")
    ...
    st.subheader("Step 2: Upload an Audio File")
    ...
    if uploaded_file is not None:
        ...
        st.subheader("Step 3: Transcribe the Audio File")
